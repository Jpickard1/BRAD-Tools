...
Usage:
    ...
    BRAD Line:
    ```
    subprocess.run([sys.executable, '<path/to/script/>/hwgFirstOrderInteractions.py', chatstatus['output-directory'], <output file>, <gene name>], capture_output=True, text=True)
    ```
