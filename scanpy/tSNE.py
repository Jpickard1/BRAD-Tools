"""
Perform t-SNE on single-cell RNA-seq data and save the results

BRAD's Command to Run this file:
subprocess.run([sys.executable, '<path/to/script/>/tsne.py', chatstatus['output-directory'], <input file>, <output file>], capture_output=True, text=True)
...
def main():
    ...
    # Compute neighbors and run t-SNE
